...
public enum ErrorCode {
    ...
    IO_EXCEPTION(1017, "Đã xảy ra lỗi đọc/ghi dữ liệu. Vui lòng thử lại sau.", HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    UN_AUTHENTICATED(1009,"Thông tin xác thực không hợp lệ !",HttpStatus.UNAUTHORIZED),
